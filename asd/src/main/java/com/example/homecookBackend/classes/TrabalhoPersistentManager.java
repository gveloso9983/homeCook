...
public class TrabalhoPersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "Trabalho";
	...
	private TrabalhoPersistentManager() throws PersistentException {
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new TrabalhoPersistentManager();
		}
